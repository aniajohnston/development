...
'''
# Triangle of side one 4 base of 6 side 2 of 3 
#perimeter of a triangle is length + base + height

side_one = 4 #variables cannot start with numbers
base = 6
side_two = 7

perimeter_triangle = side_one + base + side_two
