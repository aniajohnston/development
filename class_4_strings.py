...
my_colors = ['blue', 'green', 'red', 'orange', 'blue'] #this is a list data type

new_string = ' '.join(my_colors)  #fill parenthesis with whatever you want.
print(new_string)
...
username = '   jessica123    '
username_clean = username.strip() #this method is being applied to the variable "username"
print(len(username))
